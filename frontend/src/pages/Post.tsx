...
function SinglePost() {
  ...
  const loopThroughPostsUp = () => {
    // console.log("up current post index: ", currentPostIdIndex, dataPost.getPostById.otherPostIds.length - 1)
  ...
  const loopThroughPostsDown = () => {
    // console.log("down current post index: ", currentPostIdIndex)
    if (currentPostIdIndex > dataPost.getPostById.otherPostIds.length - 1) {
      setCurrentPostIdIndex(dataPost.getPostById.otherPostIds.length - 1);
      return
    }
    ...
    const nextPostId = dataPost.getPostById.otherPostIds[currentPostIdIndex]
    // console.log("down ---- next post ID: ", nextPostId)
    navigate(`/post/${nextPostId}`)
  }
  ...
  const isLiked = likedPosts.some((likedPost) => {
    ...
    console.log("==-=-=-=-=-=-=-=>> ", likedPost.userId, loggedInUserId)
